...
class PlayerInterface:
    def __init__(self, player, level):
        ...
        self.txtSkipLevel = "Skip this level"
        self.colortxtSkipLevel = SOKOBAN.BLACK
    ...
    def click(self, pos_click, level, game):
        ...
        # Skip level
        if x > self.posTxtSkipLevel[0] and x < self.posTxtSkipLevel[0] + self.txtSkipLevelSurface.get_width() \
        and y > self.posTxtSkipLevel[1] and y < self.posTxtSkipLevel[1] + self.txtSkipLevelSurface.get_height():
            game.skip_level()
    ...
    def render(self, window, level):
        ...
        self.txtSkipLevelSurface = self.font_menu.render(self.txtSkipLevel, True, self.colortxtSkipLevel, SOKOBAN.WHITE)
        self.posTxtSkipLevel = ((SOKOBAN.WINDOW_WIDTH - self.txtSkipLevelSurface.get_width()) - 10, 50)
        window.blit(self.txtSkipLevelSurface, self.posTxtSkipLevel)