...
class PlayerInterface:
    def __init__(self, player, level):
        ...
        self.txtSkip = "Skip this level"
        self.colorTxtSkip = SOKOBAN.BLACK
    ...
    def click(self, pos_click, level, game):
        ...
        # Skip level
        if x > self.posTxtSkip[0] and x < self.posTxtSkip[0] + self.txtSkipSurface.get_width() \
        and y > self.posTxtSkip[1] and y < self.posTxtSkip[1] + self.txtSkipSurface.get_height():
            game.skip_level()
    ...
    def render(self, window, level):
        ...
        self.txtSkipSurface = self.font_menu.render(self.txtSkip, True, self.colorTxtSkip, SOKOBAN.WHITE)
        self.posTxtSkip = ((SOKOBAN.WINDOW_WIDTH - self.txtSkipSurface.get_width()) - 10, 50)
        window.blit(self.txtSkipSurface, self.posTxtSkip)